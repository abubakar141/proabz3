            ...
            <div className="left-top flex h-full">
                ...
                <div style={styles.loginContainer}>
                    ...
                    <div className="box p-4 w-full max-w-sm">
                        <center>
                            <h2 className="text1 mb-3 text-lg ml-8">Reset password</h2>
                            <p className="text2 mb-3  text-gray-700 text-sm ml-8">Enter your email address to get instructions for resetting your password.</p>
                        </center>
